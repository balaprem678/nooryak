...
//     return (
//         <div className={`tp-about-area ${spacingCls} tp-bounce-trigger`} style={{ backgroundColor: bgColur }}>
//             <div className="container">
//                 <div className="row" style={{ display: "flex", flexWrap: "wrap" }}>

//                     {/* LEFT */}
//                     <div className="col-lg-6" style={{ width: "50%", padding: "10px" }}>
//                         <div
...
const HomeMainAbout = ({ bgColur, spacingCls = "pb-120" }: aboutPropsDT) => {
    return (
        <section
            className={`about-diagonal ${spacingCls}`}
        ...
        >
            <div className="container">
                <div className="about-diagonal-wrapper">
                    ...
                    {/* IMAGE SIDE */}
                    <div className="about-diagonal-img">
                        <div className="shape"></div>

                        <Image src={Images.about_1} alt="about" className="img-main" />
                        <Image src={Images.about_2} alt="about" className="img-small" />
                    </div>

                    {/* CONTENT */}
                    <div className="about-diagonal-content">

                        <span className="subtitle">About our Agency</span>

                        <h2 className="title">
                            Social <span>marketing</span> & advertising.
                        </h2>
                        ...
                        <a href="/about-us-light" className="btn">
                            More about us →
                        </a>
